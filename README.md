...
<p align="center">
  <img src="HOBBIT.png" alt="실물사진" width="80%">
  <img src="HOBBIT (2).png" alt="YOLO분석" width="80%">
</p>
</details>
...
<p align="center">
  <img src="Motor.png" alt="결과" width="80%">
</p>
</div>
</details>
...
* **Results**: 채널 간 시간 차이를 $112\mu s$ 해상도로 정밀 보정하여 샘플링 지연 오차를 완전히 소거함. 이를 통해 공진 주파수($159.1\text{Hz}$) 대역에서의 위상 일치 현상 및 유도성/용량성 대역에서의 미세한 각도($2\pi ft$) 변화 위상차를 정밀하게 복원하고 시각화함
<p align="center">
  <img src="RLC.png" alt="결과" width="80%">
  <img src="RLC (2).png" alt="결과" width="80%">
</p>
</div>
</details>
...
<p align="center">
  <img src="SPAM.png" alt="결과" width="80%">
  <img src="SPAM (2).png" alt="결과" width="80%">
</p>
</div>
</details>
